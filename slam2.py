...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    Xi = matrix()
    Xi.zero(dim, 1)
    Xi.value[0][0] = world_size / 2.0 # initialize to center of map
    Xi.value[1][0] = world_size / 2.0 # initialize to center of map

    for k in range(len(data)):
        # n is the index of the robot pose in the matrix/vextor
        n = k * 2
